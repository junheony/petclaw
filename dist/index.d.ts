...
export type { PetClawManifest, PetClawSkill, PetIdentity, ConsentSettings, SoulExport, } from "./protocol";
export { buildPetDID, computeIntegrityHash, verifySoulExport, buildManifest, DEFAULT_SKILLS, } from "./protocol";
